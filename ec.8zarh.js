  ...
  (() => {
    ...
    function l(e) {
      ...
      return new ResizeObserver(c => {
        ...
        r && i(r),
        n = setTimeout(
            () => {r && i(r), r = u(() => {t.forEach(o => e(o)), t.clear()})},
            250)
      })
    }
    function d(e, t) {
    ...
    var b = new MutationObserver(
        e => e.forEach(t => t.addedNodes.forEach(n => {d(n, s)})));
    b.observe(document.body, {childList: !0, subtree: !0});
    document.addEventListener('astro:page-load', () => {d(document, s)});
  })();
} catch (e) {
...
try {
  (() => {
    function i(o) {
      ...
      Object.assign(e.style, {
        ...
        userSelect: 'all'
          ...
          e.ariaHidden = 'true', e.textContent = o,
    ...
    async function l(o) {
      let e = o.currentTarget, a = e.dataset, n = !1,
          r = a.code.replace(/\u007f/g, `
`);
      try {
      ...
      t.classList.add('feedback'), t.append(a.copied), e.before(t),
          t.offsetWidth, requestAnimationFrame(() => t?.classList.add('show'));
      let c = () => !t || t.classList.remove('show'), d = () => {
        !t || parseFloat(getComputedStyle(t).opacity) > 0 ||
            (t.remove(), t = void 0)
      };
      setTimeout(c, 1500), setTimeout(d, 2500), e.addEventListener('blur', c),
          t.addEventListener('transitioncancel', d),
          t.addEventListener('transitionend', d)
    }
    function s(o) {
      o.querySelectorAll?.('.expressive-code .copy button')
          .forEach(e => e.addEventListener('click', l))
    }
    s(document);
    var u = new MutationObserver(
        o => o.forEach(e => e.addedNodes.forEach(a => {s(a)})));
    u.observe(document.body, {childList: !0, subtree: !0});
    document.addEventListener('astro:page-load', () => {s(document)});
  })();
} catch (e) {
